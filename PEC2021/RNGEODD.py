...
(both inclusive) in a single line separated by space. And they should be in ascending order.
Input:
• First-line will contain two numbers L
and R
• . 
Output:
Print all odd numbers in a single line separated by space.
Constraints
• 1≤L<R≤106
•
Sample Input 1:
